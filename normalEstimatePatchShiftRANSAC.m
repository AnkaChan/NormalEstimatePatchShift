function [ normals, knns, noncomputeCount ] = normalEstimatePatchShiftRANSAC( Pts, knnNei, knnPatch )
%% ----------------------------------------------------------------
...
noncompute_count = 0;
%% compute nomals
[normals, knns, noncomputeCount] = cmptNormalRANSAC(Debug);
