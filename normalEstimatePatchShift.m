function [ normals, knns, noncomputeCount ] = normalEstimatePatchShift( Pts, knnNei, knnPatch, neiBuildMethod )
...
if ~ exist('kdtree_build.mexw32','file')
...
%% compute nomals
[normals, knns, noncomputeCount] = cmptNormal(Debug);
